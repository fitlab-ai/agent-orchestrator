...
Scan `.agent-infra/workspace/active/{task-id}/` for technical plan files (`plan.md`, `plan-r{N}.md`):
- Read the highest-round plan file and record it as `{plan-artifact}`

Scan `.agent-infra/workspace/active/{task-id}/` for implementation report files:
...
Create `.agent-infra/workspace/active/{task-id}/{implementation-artifact}`.
...
Output file:
- Implementation report: .agent-infra/workspace/active/{task-id}/{implementation-artifact} (Round {implementation-round})
...
- [ ] Created implementation report `.agent-infra/workspace/active/{task-id}/{implementation-artifact}`
- [ ] All tests pass
