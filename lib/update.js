...
async function cmdUpdate() {
  ...
  // update skill
  copySkillDir(
    path.join(templateDir, '.agents', 'skills', 'update-ai-collaboration'),
    path.join('.agents', 'skills', 'update-ai-collaboration'),
    replacements,
    language
  );
  ok('Updated .agents/skills/update-ai-collaboration/');
  try {
    fs.unlinkSync(path.join('.agents', 'skills', 'update-ai-collaboration', 'scripts', 'sync-templates.cjs'));
  } catch {
